				...
				<div class="col-md-12 column">
					<div class="row clearfix">
						<div class="col-md-8 column">
							<img alt="" src="img/header-logo1.png" /> <img alt="" src="img/header-logo2.png" />
						</div>
									...
									<nav class="pagenav">
										<ul class="pagination pagination-lg">
											<c:if test="${page.currentPage>1 }">
												<li>
													<a href="${pageContext.request.contextPath }/ShowDownload?page=${page.currentPage-1}">&laquo;</a>
												</li>
											</c:if>
											<li>
												<a href="${pageContext.request.contextPath }/ShowDownload?page=${1}">首页</a>
											</li>
											<c:forEach begin="1" end="${page.totalPage }" step="1" var="i">
												<c:if test="${page.currentPage==i }">
													<li>
														<a href="${pageContext.request.contextPath }/ShowDownload?page=${i}">${i}
												...
												<c:if test="${page.currentPage!=i }">
													<li>
														<a href="${pageContext.request.contextPath }/ShowDownload?page=${i}">${i}</a>
													</li>
												</c:if>
											</c:forEach>
											<li>
												<a href="${pageContext.request.contextPath }/ShowDownload?page=${page.totalPage}">末页</a>
											</li>
											<c:if test="${page.currentPage< page.totalPage }">
												<li>
													<a href="${pageContext.request.contextPath }/ShowDownload?page=${page.currentPage+1}">&raquo;</a>
												</li>
											</c:if>
										</ul>
									</nav>
